     ...
     test("TC003 -Facility EHR module", async ({}) => {
        const EHRTest = new EHR(page);
         ...
         console.log("Excel data:", EHRdata);
          ...
          const {Room,PetName,Temperature,PulseRate,Respiratory,Mucous,Capillary,PulseQuality,GumColour,HeartRate,PainResponse,Weight} = EHRdata[0];
            await EHRTest.Testspecies(Room,PetName);
